...
//This controls the application of status effects that result from events rather than direct actions.
//Currently, all this does is watch unit HP and apply KO effect once HP reaches 0

//[ATTACH TO BATTLECONTROLLER]
