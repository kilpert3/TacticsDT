...
//posts notifications when equipping and un-equipping items.
//exposes a readonly list of the items which are currently equipped.
//automatically un-equip any item which had been previously equipped in an overlapping slot(s) before equipping a new item in the same slot(s).
